...
class MenuPanel<T> extends EventsComponent {
    ...
    mb: MenuBox;
    render() {
        return this.visible && <div data-seer-page-unselect="true" className='seer-menu-panel'>
            <div className='seer-menu-mask' style={{ zIndex: popoverLayer.zoom(this) }} onMouseDown={e => this.onClose(e)}></div>
            <MenuBox
